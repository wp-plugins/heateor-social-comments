jQuery( function(){
	...
	jQuery(".heateor_help_bubble").toggle(function() {
	    jQuery("#" + jQuery(this).attr("id") + "_cont").show()
	}, function() {
	    jQuery("#" + jQuery(this).attr("id") + "_cont").hide()
	});

	jQuery(".heateor_help_bubble").attr("title", heateorScHelpBubbleTitle), jQuery(".heateor_help_bubble").toggle(function() {
        jQuery("#" + jQuery(this).attr("id") + "_cont").show(), jQuery(this).attr("title", heateorScHelpBubbleCollapseTitle)
    }, function() {
        jQuery("#" + jQuery(this).attr("id") + "_cont").hide(), jQuery(this).attr("title", heateorScHelpBubbleTitle)
    });
} );